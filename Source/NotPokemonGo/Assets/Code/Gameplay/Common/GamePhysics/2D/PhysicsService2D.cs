...
namespace Code.Gameplay.Common.GamePhysics._2D
{
  public class PhysicsService2D : IPhysicsService2D
  {
    ...
    public PhysicsService2D(ICollisionRegistry collisionRegistry)
    {
