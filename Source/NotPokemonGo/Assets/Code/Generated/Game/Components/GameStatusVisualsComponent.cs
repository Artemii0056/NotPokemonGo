...
public partial class GameEntity {
    ...
    public Code.Common.CommonComponents.StatusVisualsComponent statusVisuals { get { return (Code.Common.CommonComponents.StatusVisualsComponent)GetComponent(GameComponentsLookup.StatusVisuals); } }
    ...
    public GameEntity AddStatusVisuals(Code.Gameplay.Common.Visuals.StatusVisuals.IStatusVisuals newValue) {
        ...
        var component = (Code.Common.CommonComponents.StatusVisualsComponent)CreateComponent(index, typeof(Code.Common.CommonComponents.StatusVisualsComponent));
