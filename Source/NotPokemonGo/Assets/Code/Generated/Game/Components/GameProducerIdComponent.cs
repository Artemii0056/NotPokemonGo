...
public partial class GameEntity {
    ...
    public TestECS.Gameplay.Features.Effects.ProducerId producerId { get { return (TestECS.Gameplay.Features.Effects.ProducerId)GetComponent(GameComponentsLookup.ProducerId); } }
    ...
    public GameEntity AddProducerId(int newValue) {
        ...
        var component = (TestECS.Gameplay.Features.Effects.ProducerId)CreateComponent(index, typeof(TestECS.Gameplay.Features.Effects.ProducerId));
