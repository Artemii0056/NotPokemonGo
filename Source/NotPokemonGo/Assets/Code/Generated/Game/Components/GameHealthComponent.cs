...
public partial class GameEntity {
    ...
    public Code.Gameplay.FirstComponent.Health health { get { return (Code.Gameplay.FirstComponent.Health)GetComponent(GameComponentsLookup.Health); } }
    ...
    public GameEntity AddHealth(float newValue) {
        ...
        var component = (Code.Gameplay.FirstComponent.Health)CreateComponent(index, typeof(Code.Gameplay.FirstComponent.Health));
