...
public partial class GameEntity {
    ...
    public Code.Common.CommonComponents.Damage damage { get { return (Code.Common.CommonComponents.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Common.CommonComponents.Damage)CreateComponent(index, typeof(Code.Common.CommonComponents.Damage));
