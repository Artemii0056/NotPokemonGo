...
public partial class GameEntity {
    ...
    public Code.Gameplay.FirstComponent.Damage damage { get { return (Code.Gameplay.FirstComponent.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Gameplay.FirstComponent.Damage)CreateComponent(index, typeof(Code.Gameplay.FirstComponent.Damage));
