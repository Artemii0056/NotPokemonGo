...
{
    public class UpgradePlayerPlatoonState : IPayloadedState<UnitActionPayload>
    {
        ...
        public UpgradePlayerPlatoonState(IBattleStateMachine battleStateMachine, BattleUpgradePanelPresenter battleUpgradePanelPresenter)
        {
